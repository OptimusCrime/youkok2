            ...
            <div class="row">
                <div class="col-xs-12 col-md-8">
                    ...
                    <form action="[[+TemplateHelper::url_for('auth_register')]]" method="post" id="register-form" name="register-form">
                        ...
                        <div class="form-group">
                            <label for="register-form-password1">Passord <span>*</span></label>
                        ...
                        <div class="form-group">
                            <label for="register-form-password2">Gjenta passord <span>*</span></label>
                        ...
                        <hr />
                        <button type="submit" disabled id="register-form-submit" class="btn btn-default">Registrer</button> eller <a href="[[+$SITE_URL]]">gå tilbake til forsiden</a>.
                    </form>
                </div>
