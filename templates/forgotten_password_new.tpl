...
<div class="col-md-8">
	...
	<form action="" method="post" id="forgotten-password-new-form" name="forgotten-password-new-form">
		...
		<div class="form-group">
			<label for="forgotten-password-new-form-password2">Gjennta passord <span style="color: red;">*</span></label>
			<input disabled type="password" class="form-control" id="forgotten-password-new-form-password2" name="forgotten-password-new-form-password2" placeholder="Gjennta ditt passord her" />
