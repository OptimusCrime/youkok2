[[+include file="header.tpl"]]
            <div>
                <div class="col-xs-12 col-md-8">
                    ...
                    <strong>0</strong> i <a href="[[+TemplateHelper::url_for('flat_karma')]]">karma</a>.</p>
