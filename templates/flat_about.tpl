...
<div class="row">
    <div class="col-xs-12 col-md-8">
        ...
        <p>Som student ved NTNU kommer du før eller siden over begrepet å <em>koke</em>. Et av de mest populære sidene
        for å finne kok på nettet har i mange år vært Christians Kokebok, bedre kjent som 
        <a href="http://www.youkok.com" target="_blank">Youkok.com</a>. Denne nettsiden har vært en 
        ...
        selv ut øvinger, eksamensoppgaver og løsningsforslag når han eller hun tar faget, men så fort personen er ferdig
        på NTNU stopper den å bli oppdatert. Det blir også rotete å benytte seg av en haug forskjellige ressurser, samtidig
        som det også er vanskelig å finne nye og gode sider.</p>
        <h3>Youkok2 og muligheten for alle til å bidra</h3>
        <p>Tanken vår med Youkok2 var å gjøre det mulig for alle å bidra med hva man skulle ønske. Om dette skulle være
        opplastninger direkte til siden, eller linker til nyttige sider og/eller quizer. Med et slikt system kan Youkok2
        holde seg oppdatert og relevant i fremtiden også.</p>
        <p>Man trenger ikke en gang en bruker på Youkok2 for å kunne laste opp filer eller poste linker, men disse må
        godkjennes av en administrator før de vises på siden. Om man registrerer seg blir disse synlige med en gang. Man
        får også mulighet til å opprette mapper under hvert enkelt fag.</p>
        <p>Dette var en begresning vi så på som nødvendig da vi ikke ønsker å bryte med opphavsrett eller å publisere
        filer av dårlig kvalitet. Mer informasjon om dette kan du finne under <a href="retningslinjer">retningslinjer</a>.</p>
