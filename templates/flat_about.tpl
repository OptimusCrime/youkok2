[[+include file="header.tpl"]]
            <div class="row">
                <div class="col-xs-12 col-md-8">
                    ...
                    <p>Dette var en begresning vi så på som nødvendig da vi ikke ønsker å bryte med opphavsrett eller å publisere filer av dårlig kvalitet. Mer informasjon om dette kan du finne under <a href="retningslinjer">retningslinjer</a>.</p>
