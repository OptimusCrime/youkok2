...
import {
  ...
  SIDEBAR_POST_LINK_TITLE_FETCH_STARTED, SIDEBAR_POST_LINK_TITLE_POST_ERROR,
  SIDEBAR_POST_LINK_TITLE_POST_FAILED,
  SIDEBAR_POST_LINK_TITLE_POST_FINISHED,
  SIDEBAR_POST_LINK_TITLE_POST_STARTED
} from "./constants";
import {LINK_POST_ERROR_BACKEND} from "../../constants";
...
export const postLink = (url, title) => dispatch => {
  dispatch({ type: SIDEBAR_POST_LINK_TITLE_POST_STARTED });

  postLinkRest(url, title)
    .then(response => response.json())
