...
class UpdateUserMostPopularProcessor
{
    ...
    private static function updateUserMostPopular(SessionService $sessionHandler, $key, $delta)
    {
        return $sessionHandler->forceSetData($key, $delta, SessionService::MODE_OVERWRITE);
    }
}
