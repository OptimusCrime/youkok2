...
class ArchiveVisitProcessor extends AbstractElementFactoryProcessor
{
    ...
    private static function addCourseToUserHistory(Element $element, SessionService $sessionHandler)
    {
        ...
        $sessionHandler->setData(static::SESSION_KEY, $newCourseVisits, SessionService::MODE_OVERWRITE);
    }
}
