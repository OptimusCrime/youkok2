var Youkok = (function (module) {
    ...
    module.archive = {
        ...
        init: function() {
            // Add listeners
            $('.archive-item-dropdown').on('click', Youkok.archive.itemDropdownOpen);
            $('.archive-dropdown-close').on('click', Youkok.archive.itemDropdownClose);
            
            // Load history
            Youkok.archive.getHistory();
         ...
         */
        initOnline: function() {
            $('#archive-heading-star').on('click', Youkok.archive.toggleFavorite);
        },
