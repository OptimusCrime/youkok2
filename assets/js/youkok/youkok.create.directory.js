var Youkok = (function (module) {
    ...
    module.createDirectory = {
        ...
        init: function () {
            // Add listeners
            $('#archive-create-folder').on('click', expand);
            $('#archive-create-folder-div a').on('click', collaps);
            $('#archive-create-folder-name').on('keyup', keyup);
            $('#archive-create-folder-form').on('submit', submit);
        },
    };
