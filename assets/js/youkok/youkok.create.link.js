var Youkok = (function (module) {
    ...
    module.createLink = {
        ...
        init: function () {
            // Add listeners
            $('#archive-create-link').on('click', Youkok.createLink.expand);
            $('#archive-create-link-div a').on('click', Youkok.createLink.collaps);
            $('#archive-create-link-url').on('keyup', Youkok.createLink.keyup);
            $('#archive-create-link-form').on('submit', Youkok.createLink.submit);
        },
